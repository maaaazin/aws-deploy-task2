...
<footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-green-200/60 to-white mt-40">
        <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
            ...
            <div>
                ...
                <ul className="mt-2 space-y-2">
                    ...
                    <li><a href="/" className="hover:text-green-600 transition">Careers<span className="text-xs text-white bg-green-600 rounded-md ml-2 px-2 py-1">New</span></a></li>
  ...
  <p className="max-w-60">
    Making sure every customer feels valued and appreciated.
  </p>

  <div className="flex items-center gap-4 mt-3">
    <a
      href="https://www.instagram.com/ahmadwantstosleep/?igsh=MW93ajR1ODFvOGk5MA%3D%3D&utm_source=qr#"
      target="_blank"
      rel="noreferrer"
    >
      <svg
        ...
        className="lucide lucide-instagram size-5 hover:text-pink-500"
        aria-hidden="true"
      >
    ...
    <a
      href="https://www.linkedin.com/in/mohammad-ahmad-76037b383?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"
      target="_blank"
      rel="noreferrer"
    >
      <svg
  ...
  <p className="mt-3 text-center">© 2025 CraftMyProfile</p>
</div>
